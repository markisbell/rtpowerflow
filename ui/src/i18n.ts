...
const en = {
  ...
  meas: {
    ...
    modeFull: "Smart (1 min)", modeStd: "Standard (15 min)",
    modeFullTitle: "Full smart metering: voltage, P, Q and current every minute",
    modeStdTitle: "Standard metering (Lastgang): only the 15-minute mean active power",
...
const de: typeof en = {
  ...
  meas: {
    ...
    modeFull: "Smart (1 min)", modeStd: "Standard (15 min)",
    modeFullTitle: "Volle Smart-Messung: Spannung, P, Q und Strom im Minutentakt",
    modeStdTitle: "Standardmessung (Lastgang): nur 15-Minuten-Mittelwert der Wirkleistung",
