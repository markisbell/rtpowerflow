...
\begin{figure}[htbp]
  ...
  \caption{Schritt 3 --- \ui{Live} zur Abendspitze (19:41 Uhr): Kabel
    färben sich nach Auslastung (hier bis 74\,\%), an den Häusern
...
Anhand des Screenshots (19:41 Uhr, Abendspitze mit E-Autos):
...
\midrule
U min / max & 216{,}1 / 230 V & Tiefpunkt am Strangende: $-6{,}0\,\%$ \\
 & & (EN-50160-Band: $\pm 10\,\% \Rightarrow$ 207--253 V) \\
max.\ Leitungsauslastung & 73{,}7 \% & höchstbelastetes Kabel, noch Reserve \\
max.\ Trafo-Auslastung & 64{,}4 \% & 250-kVA-Station gut ausgelastet \\
Gesamtlast & 148{,}1 kW & Haushalte + ladende E-Autos \\
Erzeugung & 2{,}1 kW & Rest-PV der Abendsonne \\
Bezug (Netz) & 152{,}2 kW & Import aus dem MS-Netz \\
Verluste & 3{,}85 kW & $\approx 2{,}6\,\%$ der Last --- Abendspitze \\
 & & treibt die $I^2R$-Verluste \\
Rechenzeit & 6{,}3 ms & Lastfluss-Dauer dieses Schrittes \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{beispiel}[Was man um 19:41 Uhr auf der Karte sieht]
Der Hauptstrang von der Station zum dichtesten Ortsteil ist orange
(74\,\%), seine Ausläufer gelbgrün; an einem Dutzend Häusern
...
zwischen 18 und 21 Uhr Richtung 216~V ab --- deutlich sichtbar über
...
\begin{figure}[htbp]
  ...
  \caption{Ansicht \ui{Schätzung}: Aus fünf Messungen und dem
    ...
    den Schätzfehler gegen die Wahrheit aus (hier 0{,}88~V).}
...
\begin{enumerate}[nosep]
  ...
  \item \textbf{+ 3 Smart Meter} an den Strangenden: Der Fehler
    fällt auf \textbf{0{,}88~V} (Screenshot) --- die Meter an den
    kritischen Enden \glqq spannen\grqq{} das Spannungsprofil auf.
    Die geschätzte maximale Leitungsauslastung (56\,\%) liegt nun
    nahe an der Wahrheit (54\,\%).
